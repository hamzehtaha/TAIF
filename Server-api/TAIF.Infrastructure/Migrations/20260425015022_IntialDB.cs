        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RateToUsd = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearlyPrice = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    YearlyDiscountPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsPublic = table.Column<bool>(type: "bit", nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    TrialDaysCount = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationChannel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderUploadId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ProviderAssetId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ProviderPlaybackId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoAssets_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "EvaluationQuestionMappings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationQuestionMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EvaluationQuestionMappings_Evaluations_EvaluationId",
                        column: x => x.EvaluationId,
                        principalTable: "Evaluations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvaluationQuestionMappings_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSubscriptions_PromoCodes_PromoCodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LessonItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AnswersJson = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
                    Score = table.Column<int>(type: "int", nullable: false),
                    IsCompleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromoCodeUsages_UserSubscriptions_UserSubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationQuestionMappings_EvaluationId",
                table: "EvaluationQuestionMappings",
                column: "EvaluationId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationQuestionMappings_EvaluationId_Order",
                table: "EvaluationQuestionMappings",
                columns: new[] { "EvaluationId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationQuestionMappings_EvaluationId_QuestionId",
                table: "EvaluationQuestionMappings",
                columns: new[] { "EvaluationId", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationQuestionMappings_OrganizationId",
                table: "EvaluationQuestionMappings",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromoCodeUsages_UserSubscriptionId",
                table: "PromoCodeUsages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptions_PromoCodeId",
                table: "UserSubscriptions",
                column: "PromoCodeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoAssets_OrganizationId",
                table: "VideoAssets",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoAssets_ProviderAssetId",
                table: "VideoAssets",
                column: "ProviderAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoAssets_ProviderUploadId",
                table: "VideoAssets",
                column: "ProviderUploadId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoAssets_Status",
                table: "VideoAssets",
                column: "Status");
        }
